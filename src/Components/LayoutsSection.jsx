    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <h2 className="md:text-4xl font-bold mb-4 leading-snug">
          <span className="text-[#61dcdf] text-[42px]">
            Custom{" "}
        ...
        <p className="text-[#617798] mb-20 max-w-2xl mx-auto text-base text-[18px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8  ">
          {features.map((feature, index) => (
            ...
            >
              ...
              />
              <h3 className="text-[24px] font-medium text-[#61dcdf] mb-3">
                {feature.title}
              </h3>
              <p className="text-[#617798] text-[18px] leading-relaxed mb-5">
                {feature.description}
              </p>
              ...
              <ul className="space-y-5">
                {feature.points.map((point, i) => (
                  <li
                    key={i}
                    className="flex items-start gap-3 text-[#617798] text-[16px] font-medium"
                  >
