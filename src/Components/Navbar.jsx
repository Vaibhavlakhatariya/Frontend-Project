        ...
        <div className="max-w-8xl  px-8 md:px-20 py-3.5 flex justify-between items-center mx-auto">
          ...
          <div className="hidden lg:flex gap-9 mr-4 items-center">
            {navitems.map((item) => (
              <div
                key={item.data.uid}
                className="relative flex group gap-2 justify-center items-center text-gray-500 cursor-pointer hover:text-gray-800 font-Work Sans"
              >
                <NavLink
                  to={item.data.slug}
                            ...
                            <div className="flex flex-col gap-3">
                              {child.children?.map((sub) => (
                                <NavLink
                                  key={sub.data.uid}
                                  to={sub.data.slug}
                                  className="relative inline-block text-gray-500 font-Work Sans after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:bg-blue-500 after:w-0 after:origin-left after:transition-all after:duration-300 hover:after:w-25 hover:after:origin-right"
                                >
                                  {sub.title}
                                </NavLink>
                              ))}
                        ...
                        {item.children.map((child) => (
                          ...
                          >
                            <div className="flex group justify-between items-center">
                              <Link
                                to={child.data.slug}
                                className="relative inline-block text-gray-500 after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:bg-blue-500 after:w-0 after:origin-left after:transition-all after:duration-300 hover:after:w-25 hover:after:origin-right"
                              >
                                {child.title}
                              </Link>
                              {(child.title === "Header" ||
